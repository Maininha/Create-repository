...
// Importações corretas para a biblioteca OpenPDF
...
public class GeradorPdfRelatorio {
    ...
    // Paleta de cores baseada na identidade visual marrom e dourada do seu sistema
    private static final Color COR_PRIMARIA = new Color(80, 50, 20);     // Marrom Escuro
    private static final Color COR_SECUNDARIA = new Color(245, 166, 35); // Dourado / Laranja
    private static final Color COR_ZEBRA = new Color(250, 248, 245);      // Creme bem claro
    private static final Color COR_TEXTO = new Color(51, 51, 51);        // Cinza Escuro

    // ========================================================================
    // 1. RELATÓRIO DE ATIVIDADES RECENTES
    // ========================================================================
    public static void gerarRelatorioAtividades(List<Atividade> atividades) {
        ...
        try {
            ...
            document.add(tabela);
            document.close();
            alertaEAbrirArquivo(caminhoArquivo);
    ...
    public static void gerarRelatorioAssociados(List<Associado> associados) {
        ...
        // Modo Paisagem (rotate) para caber os dados confortavelmente na horizontal
    ...
    // ========================================================================
    // 3. RELATÓRIO FINANCEIRO (RESOLVE O PROBLEMA DE SEPARAÇÃO ENTRADAS/SAÍDAS)
    // ========================================================================
    public static void gerarRelatorioFinanceiro(List<Financeiro> movimentacoes) {
        String home = System.getProperty("user.home");
        ...
        try {
            ...
            if (movimentacoes == null || movimentacoes.isEmpty()) {
                ...
                for (Financeiro f : movimentacoes) {
                    ...
                    String sinal = "+ ";
                    // Verifica se é saída para somar no balanço correto
            ...
            // Bloco final com o Balanço Geral calculado dinamicamente
            ...
            // Se o saldo for positivo fica Verde, se for negativo fica Vermelho
    ...
    // ========================================================================
    // MÉTODOS ESTÁTICOS AUXILIARES (ESTILIZAÇÃO DAS TABELAS E DOCUMENTO)
    // ========================================================================
    ...
    private static void adicionarCelulaDado(PdfPTable table, String texto, boolean zebra, int alinhamento) {
        ...
        if (zebra) {
            cell.setBackgroundColor(COR_ZEBRA);
        } else {
        ...
        cell.setBorderColorBottom(new Color(230, 220, 205)); // Borda sutil de separação
        table.addCell(cell);
    }

    private static void alertaEAbrirArquivo(String caminho) {
        JOptionPane.showMessageDialog(null,
                "Ficheiro PDF gerado com sucesso!\nGuardado em: " + caminho,
                "Sucesso",
    ...
    private static void exibirErro(Exception e) {
        JOptionPane.showMessageDialog(null,
                "Erro ao gerar o documento PDF: " + e.getMessage(),
                "Erro de Exportação",
